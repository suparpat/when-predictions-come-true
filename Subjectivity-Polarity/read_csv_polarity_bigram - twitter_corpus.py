...
import train_polarity_bigram_twitter_corpus as trainer
...
for index,tweet in enumerate(tweets):
    ...
    temp = trainer.classifier.prob_classify(trainer.bigram_word_feats(trainer.nltk.word_tokenize(tweet))).prob('pos')
...
df.to_csv('twittercorpus_polarity_.csv',index=False)
